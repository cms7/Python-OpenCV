...
parser.add_argument('--input', help='Path to image or video. Skip to capture frames from camera', default= input)
...
cv.imwrite('HED_HE_Wheel.jpg',out)
end = time.perf_counter()
print(end)
#to run use following in terminal
# python edge_detector.py --input images/LowContrast/contrast.jpg --prototxt deploy.prototxt --caffemodel hed_pretrained_bsds.caffemodel --width 1630 --height 1630
